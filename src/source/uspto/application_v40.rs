...
pub struct UsptoApplicationV40Adapter;

impl FormatAdapter for UsptoApplicationV40Adapter {
    fn parse_document(&self, input: &str) -> Result<PatentDocument, ParseError> {
        application_v4x::parse_document(input, SourceFormat::UsptoApplicationV40)
    }
