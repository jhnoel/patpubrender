...
pub struct UsptoApplicationV43Adapter;

impl FormatAdapter for UsptoApplicationV43Adapter {
    fn parse_document(&self, input: &str) -> Result<PatentDocument, ParseError> {
        application_v4x::parse_document(input, SourceFormat::UsptoApplicationV43)
    }
