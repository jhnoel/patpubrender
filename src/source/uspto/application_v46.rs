...
pub struct UsptoApplicationV46Adapter;

impl FormatAdapter for UsptoApplicationV46Adapter {
    fn parse_document(&self, input: &str) -> Result<PatentDocument, ParseError> {
        application_v4x::parse_document(input, SourceFormat::UsptoApplicationV46)
    }
