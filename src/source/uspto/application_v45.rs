...
pub struct UsptoApplicationV45Adapter;

impl FormatAdapter for UsptoApplicationV45Adapter {
    fn parse_document(&self, input: &str) -> Result<PatentDocument, ParseError> {
        application_v4x::parse_document(input, SourceFormat::UsptoApplicationV45)
    }
