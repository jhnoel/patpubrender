...
pub struct UsptoApplicationV41Adapter;

impl FormatAdapter for UsptoApplicationV41Adapter {
    fn parse_document(&self, input: &str) -> Result<PatentDocument, ParseError> {
        application_v4x::parse_document(input, SourceFormat::UsptoApplicationV41)
    }
